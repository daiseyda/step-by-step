...
START_TEST(test_17) {
  const void *str1 = "checkplszooergkerpowkerl;3p4o-gik5hj0-3ko[lpwe];";
  const void *str2 = "checkpls";
  s21_size_t n = 0;
  ck_assert_int_eq(s21_memcmp(str1, str2, n), memcmp(str1, str2, n));
}
